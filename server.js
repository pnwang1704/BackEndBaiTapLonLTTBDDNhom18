...
// [THÊM DÒNG NÀY] Import route thanh toán
...
app.listen(PORT, "0.0.0.0", () => {
  ...
  console.log(
    `Electronics: http://192.168.102.20:${PORT}/api/categories/electronics`
  );
  console.log(
    `Chi tiết sản phẩm: http://192.168.102.20:${PORT}/api/products/6731a8d8f1a2c3d4e5f6g7h8`
  );
});
